...
export default function Detail16() {
  return (
    <div>
                ...
                <div className="container">
                  <div className="row g-4 align-items-center text-center text-lg-start">
                    ...
                    <div className="col-lg-6">
                      <div className="mb-1">
                        <h2 className="text-dark fw-bold display-6">Access & Role Management</h2>
                      ...
                      <div className="mb-1">
                        ...
                        <p className="text-muted mt-2">
                         A security feature that controls user access by defining roles, permissions, and responsibilities
                        </p>
                      </div>
                      ...
                      <div className="mb-1">
                        ...
                        <p className="text-muted mt-2">
                          Administrators assign role-based permissions to users, ensuring each user can access only the data and functions relevant to their role. All actions are logged for audit and compliance purposes.
                        </p>
                      </div>
                      ...
                      <div className="mb-1">
                        ...
                        <ul>
                          <li>Operators monitoring data without configuration access</li>
                          <li> Engineers managing devices and firmware updates</li>
                          <li>Administrators controlling system-wide settings</li>
                        </ul>
                      </div>
                      ...
                      <div className="mb-1">
                       ...
                       <ul>
                          <li>Enhanced system security and data protection</li>
                          <li>Clear accountability and access control</li>
                          <li>Reduced risk of unauthorized changes</li>
                          <li>Compliance with enterprise and government security standards</li>
                        </ul>
                      </div>
                    </div>
                    <div className="col-lg-6">
