...
export default function Detail9() {
  return (
    <div>
                ...
                <div className="container">
                  <div className="row g-4 align-items-center text-center text-lg-start">
                    ...
                    <div className="col-lg-6">
                      <div className="mb-4">
                        <h1 className="text-dark fw-bold display-6">Real-Time Data Pipeline</h1>
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-muted mt-2">
                          A high-performance data processing pipeline that captures, processes, and delivers data from connected devices in real time, enabling instant visibility and rapid decision-making.
                        </p>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-muted mt-2">
                          Data is continuously collected from sensors and field devices, filtered and processed at the edge, and securely transmitted to centralized systems or dashboards with minimal latency.
                        </p>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <ul>
                          <li>.Live monitoring of water levels, energy consumption, or equipment health</li>
                          <li>Instant alerts for threshold breaches or abnormal conditions</li>
                          <li>Real-time operational dashboards for control rooms</li>
                        </ul>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <ul>
                          <li>Faster response to critical events .</li>
