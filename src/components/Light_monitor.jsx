import lmbg from "../assets/lmbg.png";
...
export default function Light_monitor() {
  const [selectedImage, setSelectedImage] = useState(lm1);
  const thumbnails = [lm2, lm3, lm4, lm5];
  return (
    <div>
