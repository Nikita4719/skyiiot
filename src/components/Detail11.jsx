import d111 from "../assets/d111.png";

export default function Detail11() {
  return (
    <div>
                ...
                <div className="container">
                  <div className="row g-4 align-items-center text-center text-lg-start">
                    ...
                    <div className="col-lg-6">
                      <div className="mb-4">
                        <h1 className="text-dark fw-bold display-6">Secure & Compliant Architecture</h1>
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-muted mt-2">
                          A security-first system design that protects devices, data, and communications while meeting industry and regulatory compliance requirements.
                        </p>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-muted mt-2">
                          Security controls are embedded across hardware, firmware, network, and application layers, including encryption, authentication, access control, and secure updates.
                        </p>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <ul>
                          <li>Utilities and critical infrastructure systems.</li>
                          <li>Government and public sector deployments.</li>
                          <li>Industrial environments with compliance needs.</li>
                        </ul>
                      </div>
                      ...
                      <div className="mb-3">
                        <h2 className="fw-semibold text-dark mt-3">Business Benefits</h2>
                         <ul>
                          ...
                          <li>Regulatory and compliance readiness</li>
                          <li>Reduced risk of data breaches</li>
                          <li> Increased trust and system reliability</li>
                        </ul>
                      </div>
                    </div>
                    <div className="col-lg-6">
