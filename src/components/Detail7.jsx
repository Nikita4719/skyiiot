...
export default function Detail7() {
  return (
    <div>
                ...
                <div className="container">
                  <div className="row g-4 align-items-center text-center text-lg-start">
                    ...
                    <div className="col-lg-6">
                      <div className="mb-4">
                        <h1 className="text-dark fw-bold display-6">End-to-End Security</h1>
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-muted mt-2">
                          A comprehensive security framework that protects devices, data, and communications throughout the entire IIoT ecosystem.
                        </p>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-muted mt-2">
                          Security mechanisms such as encrypted communication, device authentication, secure firmware updates, and role-based access control are applied across all system layers.
                        </p>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <ul>
                          <li>Utility and government infrastructure systems</li>
                          <li>Industrial automation and monitoring platforms</li>
                          <li>Remote asset control and telemetry systems</li>
                        </ul>
                      </div>
                      ...
                      <div className="mb-3">
                        <h2 className="fw-semibold text-dark mt-3">Business Benefits</h2>
                         <ul>
                          <li>Protection against unauthorized access and cyber threats .</li>
                          <li>Secure and compliant data handling</li>
                          <li>Reduced risk of operational disruptions .</li>
                          <li>Increased trust and regulatory readiness</li>
                        </ul>
                      </div>
                    </div>
                    <div className="col-lg-6">
