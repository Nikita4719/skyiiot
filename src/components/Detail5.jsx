                ...
                <div className="container">
                  <div className="row g-4 align-items-center text-center text-lg-start">
                    ...
                    <div className="col-lg-6">
                      <div className="mb-4">
                        <h1 className="text-dark fw-bold display-6">Plug-and-Play Configuration</h1>
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-muted mt-2">
                          A simplified device deployment approach that enables instant setup and commissioning without complex manual configuration.
                        </p>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <ul>
                          <li>Devices automatically detect connected sensors, communication modules</li>
                          <li>predefined settings. Configuration profiles are applied remotely, allowing the system</li>
                          <li>to become operational immediately after installation.</li>
                        </ul>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <ul>
                          <li>Rapid deployment of RTUs and gateways in water supply networks.</li>
                          <li>Large-scale rollout of smart meters and field devices.</li>
                          <li>Remote installations with limited technical manpower.</li>
                        </ul>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <ul>
                          <li>Faster deployment and commissioning</li>
                          <li>Reduced installation errors and manpower costs</li>
                          <li> Easy scalability across multiple locations</li>
                          <li>Lower operational and maintenance overhead</li>
                        </ul>
                      </div>
                    </div>
                    <div className="col-lg-6">
