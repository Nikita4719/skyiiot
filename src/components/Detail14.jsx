                    ...
                    <div className="col-lg-6">
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-muted mt-2">
                          A capability that allows device settings, parameters, and firmware to be configured or updated remotely without physical access to the device.
                        </p>
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <p className="text-muted mt-2">
                         Secure over-the-air (OTA) mechanisms push configuration changes and firmware updates to devices. Devices validate updates before applying them to ensure safe and uninterrupted
                        </p>
                      </div>
