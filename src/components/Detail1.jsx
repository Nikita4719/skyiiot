            ...
            <div className="row g-4 align-items-center text-center text-lg-start">
              ...
              <div className="col-lg-6">
                ...
                <div className="mb-3">
                  ...
                  <p className="text-muted mt-2">
                    Smart factory sensors detect vibration anomalies and send only critical data to the cloud.
                  </p>
                </div>
                ...
                <div className="mb-3">
                  ...
                  <p className="text-muted mt-2">
                    Lower bandwidth usage by transmitting less data, improved response times, and enhanced operational efficiency.
                  </p>
                  <p className="text-muted mt-3">
                    Want to integrate Edge Analytics into your operations?
                  </p>
                </div>
              </div>
              <div className="col-lg-6">
